...
inputs/identity_lock/
    ...
    Placements_ByPerson_v44.csv          # 26,401 identity-locked placements
```
...
|---|---|---|
| `out/Placements_Flat.csv` | 26,401 | All placements, identity-locked |
| `out/Placements_ByPerson.csv` | 26,401 | Placements joined to person identity |
...
| Placements (identity-locked) | 26,401 |
...
| `Placements_ByPerson` | v44 | 26,401 |
