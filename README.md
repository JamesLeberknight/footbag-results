...
inputs/identity_lock/
    ...
    Placements_ByPerson_v49.csv          # 26,326 identity-locked placements
```
...
|---|---|---|
| `out/Placements_Flat.csv` | 26,326 | All placements, identity-locked |
| `out/Placements_ByPerson.csv` | 26,326 | Placements joined to person identity |
...
| Placements (identity-locked) | 26,326 |
...
| `Placements_ByPerson` | v49 | 26,326 |
