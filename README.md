...
inputs/identity_lock/
    Persons_Truth_Final_v37.csv          # 3,455 canonical persons
    Persons_Unresolved_Organized_v28.csv # 82 unresolved entries
    Placements_ByPerson_v53.csv          # 26,397 identity-locked placements
```
...
|---|---|---|
| `out/Placements_Flat.csv` | 26,397 | All placements, identity-locked |
| `out/Placements_ByPerson.csv` | 26,397 | Placements joined to person identity |
...
| Placements (identity-locked) | 26,397 |
...
|---|---|---|
| `Persons_Truth_Final` | v37 | 3,455 |
| `Persons_Unresolved_Organized` | v28 | 82 |
| `Placements_ByPerson` | v53 | 26,397 |
...
│   │   ├── Persons_Truth_Final_v37.csv
│   │   ├── Persons_Unresolved_Organized_v28.csv
│   │   └── Placements_ByPerson_v53.csv
