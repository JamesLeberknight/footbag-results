...
Modes:
  ...
  --generate  (default)
    Reads:  inputs/identity_lock/Persons_Unresolved_Organized_v18.csv
    Reads:  inputs/identity_lock/Persons_Truth_Final_v18.csv
    Reads:  inputs/identity_lock/Placements_ByPerson_v21.csv  (for appearance counts)
...
UNRESOLVED_CSV = IDENTITY_LOCK / "Persons_Unresolved_Organized_v18.csv"
TRUTH_CSV = IDENTITY_LOCK / "Persons_Truth_Final_v18.csv"
PLACEMENTS_CSV = IDENTITY_LOCK / "Placements_ByPerson_v21.csv"
