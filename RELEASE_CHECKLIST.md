...
☐ `inputs/identity_lock/` contains **only**:
  - `Persons_Truth_Final_v21.csv`
  - `Persons_Unresolved_Organized_v19.csv`
  - `Placements_ByPerson_v22.csv`
...
python 02p5_player_token_cleanup.py \
  --identity_lock_placements_csv inputs/identity_lock/Placements_ByPerson_v22.csv \
  --identity_lock_persons_truth_csv inputs/identity_lock/Persons_Truth_Final_v21.csv \
...
☐ `out/persons_truth.lock` contains:
  - `"file": "Persons_Truth_Final_v21.csv"`, `"rows": 3343`
